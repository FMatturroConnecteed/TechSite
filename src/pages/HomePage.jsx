...
const HomePage = () => {
  return (
    <div className="min-h-screen">
      <section className="bg-gradient-to-b from-motor-black to-motor-gray text-white py-20" style={{
        backgroundImage: 'url(https://images.pexels.com/photos/29909013/pexels-photo-29909013.jpeg)',
